...
My research interests lie in **Multimodal Intelligence**, especially on **Multi Modality**, **Representation Learning**, and **World Modeling**.
...
<div style="display: flex; align-items: center; margin-bottom: 25px;">
  ...
  <div style="width: 30%; max-width: 200px; display: flex; justify-content: center; align-items: center;">
    <img src="images/affiliation/JHU_logo.png" alt="JHU Logo" style="width: 60%; object-fit: contain;">
  </div>
</div>
